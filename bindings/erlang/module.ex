defmodule RpiRgb do
  ...
  # def set_image(_a, _b, _c, _d, _e, _f, _g, _h) do
  #   raise "NIF set_image/8 not implemented"
  # end
...
defmodule Run do
  ...
  def run do
    ...
    font = RpiRgb.load_font(~c"../../fonts/4x6.bdf")
    baseline = RpiRgb.baseline_font(font)
    RpiRgb.draw_text(offscreen_canvas, font, 0, baseline, 127, 255, 255, ~c"Emma jtm <3", 0)
