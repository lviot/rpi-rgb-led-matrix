...
static ERL_NIF_TERM set_image_nif(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    if (!enif_get_resource(env, argv[0], CANVAS_RES_TYPE, (void *)&canvas_res) ||
        ...
        !enif_get_list_length(env, argv[3], &image_buffer_length) ||
        !enif_get_uint64(env, argv[4], &buffer_size_bytes) ||
    ...
    set_image(*canvas_res, offset_x, offset_y, image_buffer, buffer_size_bytes, image_width, image_height, (char)is_bgr);
