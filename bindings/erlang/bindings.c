...
static ERL_NIF_TERM led_matrix_swap_on_vsync_nif(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    struct LedCanvas **new_canvas_res = enif_alloc_resource(CANVAS_RES_TYPE, sizeof(struct LedCanvas *));

    *new_canvas_res = led_matrix_swap_on_vsync(*matrix_res, *canvas_res);

    ERL_NIF_TERM term = enif_make_resource(env, new_canvas_res);
...
/*static ERL_NIF_TERM set_image_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct LedCanvas **canvas_res;
    int offset_x;
    int offset_y;
    ...
    if (!enif_get_resource(env, argv[0], CANVAS_RES_TYPE, (void *)&canvas_res) ||
        ...
        !enif_get_int(env, argv[3], &image_buffer) ||
        !enif_get_int(env, argv[4], &buffer_size_bytes) ||
        !enif_get_int(env, argv[5], &image_width) ||
        !enif_get_int(env, argv[6], &image_height) ||
        !enif_get_int(env, argv[7], &is_bgr)) {
        return enif_make_badarg(env);
    }
...
static ERL_NIF_TERM load_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM baseline_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM height_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM character_width_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM create_outline_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM delete_font_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM draw_text_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM vertical_draw_text_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
...
static ERL_NIF_TERM draw_circle_nil(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    struct RGBLedMatrix **matrix_res;
    int brightness;
